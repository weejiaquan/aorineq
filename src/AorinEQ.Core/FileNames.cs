...
public static class FileNames
{
    ...
    /// that the resulting path stays well inside MAX_PATH — a name from an aorineq:// link
    ...
    /// from an aorineq:// link — or null when it's fine. <paramref name="what"/> names the
