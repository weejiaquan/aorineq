...
public sealed class ScheduledTaskAutostart
{
    ...
    public ScheduledTaskAutostart(string taskName = "AorinEQ", bool highestRunLevel = true, bool logonTrigger = true)
    {
    ...
    public void Enable(string exePath)
    {
        ...
        var xmlPath = Path.Combine(Path.GetTempPath(), $"aorineq-task-{Guid.NewGuid():N}.xml");
        try
        {
