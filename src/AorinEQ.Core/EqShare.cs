...
/// <c>aorineq://apply-preset</c> link, so a tuning can be shared as a LINK with nothing
...
public static class EqShare
{
    ...
    /// <summary>Builds the full <c>aorineq://apply-preset</c> share link for a preset, or
