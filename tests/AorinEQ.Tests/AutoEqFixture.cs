...
/// <summary>A REAL AutoEq ParametricEQ file, captured 2026-08-12 from
...
/// — the community-standard Equalizer APO parametric format this app round-trips.</summary>
public static class AutoEqFixture
{
    public const string Hd650ParametricEq = """
        Preamp: -6.1 dB
