...
/// switch, pasted text, an aorineq:// preset link, a scope or mode switch) swapped the band
...
public class EqStripModelTests
{
    ...
    {
        // aorineq://apply-preset with an inline payload: the same projection, so a shared
