...
/// GET https://api.github.com/repos/weejiaquan/apo-volume/releases/latest, captured 2026-08-12
...
public static class GitHubReleaseFixture
{
    public const string LatestV180Json = """
        {
          "url": "https://api.github.com/repos/weejiaquan/apo-volume/releases/368921684",
          "assets_url": "https://api.github.com/repos/weejiaquan/apo-volume/releases/368921684/assets",
          "upload_url": "https://uploads.github.com/repos/weejiaquan/apo-volume/releases/368921684/assets{?name,label}",
          "html_url": "https://github.com/weejiaquan/apo-volume/releases/tag/v1.8.0",
          "id": 368921684,
          "author": {
            "login": "weejiaquan",
            "id": 15049008,
          ...
          "assets": [
            {
              "url": "https://api.github.com/repos/weejiaquan/apo-volume/releases/assets/510818473",
              "id": 510818473,
              ...
              "updated_at": "2026-08-12T00:12:15Z",
              "browser_download_url": "https://github.com/weejiaquan/apo-volume/releases/download/v1.8.0/ApoVolume.exe"
            }
          ],
          "tarball_url": "https://api.github.com/repos/weejiaquan/apo-volume/tarball/v1.8.0",
          "zipball_url": "https://api.github.com/repos/weejiaquan/apo-volume/zipball/v1.8.0",
          "body": "Volume mode, onboarding mode choice, percent-text alignment, custom muted artwork + mute-dim slider, two-column Settings."
        }
        """;

    /// <summary>The same release with an ApoVolume.exe.sha256 asset spliced in (identical asset
    ...
    public static string WithSha256Asset(string tag = "v1.8.0") => LatestV180Json
        ...
        .Replace("\"assets\": [", """
            "assets": [
                {
                  "url": "https://api.github.com/repos/weejiaquan/apo-volume/releases/assets/510818474",
                  "id": 510818474,
                  "node_id": "RA_kwDOTe67O84ecniq",
                  "name": "ApoVolume.exe.sha256",
                  "label": "",
                  ...
                  "created_at": "2026-08-12T00:12:10Z",
                  "updated_at": "2026-08-12T00:12:15Z",
                  "browser_download_url": "https://github.com/weejiaquan/apo-volume/releases/download/v1.8.0/ApoVolume.exe.sha256"
                },
            """);
}
